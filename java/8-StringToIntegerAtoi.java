...
signature accepts a const char * argument, please click the reload button 
...
class Solution {
    public int myAtoi(String str) {
        ...
        int i = 0;
        while(str.charAt(i) == ' ') ++i; //skip whitespace
        ...
        for( ;i < str.length() && Character.isDigit(str.charAt(i)); i++) {
            ...
            if(res/10 != prev) return sign>0?Integer.MAX_VALUE:Integer.MIN_VALUE;
        }
        return res*sign;        
    }
}
